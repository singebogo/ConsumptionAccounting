$(document).ready(function (e) {
    ...
    function GenerColumns() {
        var columns = [{
            ...
            footerFormatter: function (value) {
                return "Sum of monthly consumption";
            },
        ...
        for (var i = 1; i <= monthcount; i++) {
            ...
            obj = {
                ...
                title: i,
                align: 'center',
                titleTooltip: month,                        //鼠标移动到列头上就会出现提示文字
            ...
            responseHandler: function (data) {
                ...
                for (var key in data) {
                    ...
                    for (let i = 0; i < value.length; i++) {
                        let inoutdate = value[i].month.substring(0, 7);
    ...
    function merge_footer() {
        ...
        var footer_tbody = $('#monthTable tfoot');
    ...
    $('#monthTable').on('mouseenter', 'td', function (e) {
        $e = $(e.target);
    ...
    function changeYear(date) {
        if (("" + curyear).localeCompare(date) != 0) {
            ...
            // monthTableInit();
            $('#monthTable').bootstrapTable('refreshOptions', {
                columns: GenerColumns(),
            });
