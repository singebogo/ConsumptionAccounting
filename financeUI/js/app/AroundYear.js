$(document).ready(function (e) {
    ...
    function GenerColumns() {
        var columns = [{
            ...
            footerFormatter: function (value) {
                return "Sum of A Round Year Consumption";
            },
        ...
        for (var i = curyear - aRound; i <= curyear; i++) {

            obj = {
                field: i,
                title: i,
                align: 'center',
                titleTooltip: i,                        //鼠标移动到列头上就会出现提示文字
    ...
    function aRoundYearTableInit() {
        $('#aRoundYearTable').bootstrapTable({
            ...
            queryParams: function (params) {
                return {year: curyear, pervyear: pervyear, type: '2'};
            },
            ...
            responseHandler: function (data) {
                ...
                for (var key in data) {
                    ...
                    for (let i = 0; i < value.length; i++) {
                        let inoutdate = value[i].year.substring(0, 4);
    ...
    function merge_footer() {
        ...
        var footer_tbody = $('#aRoundYearTable tfoot');
    ...
    $('#aRoundYearTable').on('mouseenter', 'td', function (e) {
        $e = $(e.target);
    ...
    function changeYear(date) {
        if (("" + curyear).localeCompare(date) != 0) {
            ...
            // 刷新 效率低
            // $('#monthTable').bootstrapTable('destroy');
            // monthTableInit();
            $('#aRoundYearTable').bootstrapTable('refreshOptions', {
                columns: GenerColumns(),
            });
